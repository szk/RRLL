class Level {
    constructor(max_x_, max_y_, aspect_, root_texture_) // XXX use argument for 
    {
        this.terrain = null;
    ...
    get_terrain() { return this.terrain; }
    get_stain() { return this.stain; }
    get_entity() { return this.entity; }
    get_avatar() { return this.carrier; }
    get_visible_entity() { return this.visible_entity; }

    update_levelstat(entity_)
    {
    }
    ...
    get_entity_on_tile(tile_x_, tile_y_)
    {
